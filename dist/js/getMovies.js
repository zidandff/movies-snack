...
function renderTrendingMovies(data) {
  ...
  const sliderSkeleton = document.querySelector(
    ".slider-movies.skeleton-loading"
  );
...
function renderNewTrailer(data) {
  ...
  const trailerWrapper = document.querySelector(
    ".slider-trailer .swiper-wrapper"
  );
...
function renderModalTrailer(data) {
  const trailerVideo = data.videos.results.filter(
...
function templateGalleryTop({
  ...
  return `<div class="swiper-slide">
                <img class="bg-gallery" src="${IMAGES_ENDPOINT}w780${
  ...
  return `<div class="card-wrapper">
                <div class="card-movies">
                    <div class="overlay">
                        ...
                        <div><img src="dist/img/star.svg" class="star-slider">${vote_average}</div>
...
function templateMovieDetail({
  ...
  return `<div class="poster-detail">
    <img src="${IMAGES_ENDPOINT}w780${poster_path}" alt="">
            ...
            <div class="option">
                <img src="dist/img/playlist.svg" alt="">
                <img src="dist/img/love.svg" alt="">
                <img src="dist/img/share.svg" alt="">
                </div>`;
}
